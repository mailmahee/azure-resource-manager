...
This repo contains an Azure Resource Manager template to deploy Scylla DB cluster on Azure cloud. This is an automated deployment that can deploy a multi-region Scylla cluster to azure. The deployed Scylla cluster gets hosted on 3 nodes residing in 3 separate public subnets and create a universe among them. This repo is ideal to get you running a Scylla cluster in a few steps.

<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fmailmahee%2Fazure-resource-manager%2Fmaster%2Fscylla_deployment.json" target="_blank">
    <img src="https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazure.png"/>
</a>
<a href="http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2Fmailmahee%2Fazure-resource-manager%2Fmaster%2Fscylla_deployment.json" target="_blank">
    <img src="https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/visualizebutton.png"/>
</a>


# Prerequisites 
  1. Create a resource group for our Scylla DB deployment.
  ...
  2. Create an SSH key for our user to get access to deployed Scylla VM's.
     ...
     - Once you select a location for the key, you’ll be prompted to enter an optional passphrase which encrypts the private key file on disk.
       ...
       ``` 
      - After this, you will have a public and private key that you can use to authenticate Scylla DB VM's.
        ```
...
<a href="https://shell.azure.com" target="_blank">
  ...
  - Clone this repo.
    ```
    $ git clone https://github.com/scylladb/azure-resource-manager.git
    ```
  ...
  - Use Azure CLI command to create deployments <br/> 
    ```
    $ az group deployment create --resource-group <Your-Azure-Resource-Group> --template-file scylla_deployment.json --parameters ClusterName='<Your-Cluster-Name>' SshUser='<Your-SSH-USER>' ScyllaVersion='1.1.0' SshKeypair='<Your-SSH-USER-PublicKey>'
    ```
  - Once the deployment creation is complete, you can describe it as shown below.
    ...
    ```
    In the output, you will get the Scylla DB admin URL, JDBC URL connection string. You can use Scylla admin URL to access admin portal.
...
## Deploying From Azure Portal
 - Clone this repo locally.
  ...
  - Click `Load file` button in specify template section and upload the `scylla_deployment.json` file from cloned repo. 
  ...
  -  Once deployments get compleated, you can access the Scylla DB admin from URL you get in the deployment output section.
